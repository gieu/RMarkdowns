...
Como el p-valor es 0,14, no se puede rechazar la hipótesis nula con cualquiera de los niveles de significancia posibles (1%, 5%, 10%).

**Conclusión**

Como no se rechaza la hiótesis nula:
No hay correlación entre las variables del puntaje obtenido en el la prueba de Cultura General y el promedio acumulado de los estudiantes.
