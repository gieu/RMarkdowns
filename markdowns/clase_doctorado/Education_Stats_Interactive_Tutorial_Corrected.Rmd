...
```{r learnr, include=FALSE}
# Install the learnr package (if not already installed)
# with a preselected CRAN mirror
...
data <- read_excel("https://grupoinformaticaeducativa.uninorte.edu.co/shiny/datos/Education_Research_Sample_Data.xlsx")
