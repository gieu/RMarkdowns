...
knitr::include_graphics("https://echidna.informaticaeducativa.cf/datos/Figures/Factor%20Analysis.png")
```
...
```{r, out.width = "400px", fig.align="center"}
knitr::include_graphics("https://echidna.informaticaeducativa.cf/datos/Figures/PCA.png")
```
...
```{r, out.width = "400px", fig.align="center"}
knitr::include_graphics("https://echidna.informaticaeducativa.cf/datos/Figures/resultsFactorAnalysis.png")
```
...
* Use the following funtion to create a Scree Plot and choose a number of factors
