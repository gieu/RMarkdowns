...
typesOfKnowledge <- read.csv2("https://echidna.informaticaeducativa.cf/datos/typesOfKnowledge.csv",header=TRUE,sep=",", row.names = 1)
meltedToK <- read.csv("https://echidna.informaticaeducativa.cf/datos/meltedData.csv",header=TRUE,sep=",", row.names = 1)
