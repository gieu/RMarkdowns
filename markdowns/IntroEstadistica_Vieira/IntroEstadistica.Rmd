...
Now that you have mastered the basic instructions in R, let's do some analysis in the  next section!
...
* Verifica que la desviaci&oacute;n est&aacute;ndar 
...
Qu&oacute; puedes concluir de la tabla de correlaciones?
